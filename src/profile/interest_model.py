...
SURVEY_TOPIC_MAP: dict[str, list[str]] = {
    "AI/LLM": ["ai", "llm", "machine-learning", "deep-learning", "agents"],
    "DevTools": ["developer-tools", "cli", "terminal", "debugging", "testing"],
    "前端框架": ["frontend", "react", "vue", "typescript", "javascript"],
    "后端/云原生": ["backend", "cloud", "kubernetes", "docker", "serverless"],
    "Rust 生态": ["rust", "cargo", "wasm"],
    "Go 生态": ["go", "golang"],
    "数据库": ["database", "sql", "nosql", "data-stores"],
    "安全": ["security", "privacy", "encryption", "zero-trust"],
    "编译器/语言": ["compiler", "language", "parser", "linter"],
    "游戏开发": ["game", "game-engine", "gamedev"],
